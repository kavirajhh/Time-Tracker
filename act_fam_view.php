		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url(images/bg-01.jpg);">
					...
					<div align="center">
					  <p class="login100-form-title-1 style3">Add Activity to Product Family</p>
					  </div>
				</div>
				...
				<?php 
					...
					$sql="SELECT * FROM activity where id  not in (select act_id from act_family where fam_id='".$family."')";
					...
					if ($result->num_rows > 0) 
						...
						echo "<tr><TH colspan=3>Add activity to $f_name Product Family</TH></tr>";
						...
						{	while($row = mysqli_fetch_assoc($result)) {
								...
								echo "<tr><td>$i</td><td>$activity</td><td bgcolor=#039BE6 align='center'><a href=act_fam_add.php?a_id=$id>Add</td></a></tr>";
			...
			<div ><?php echo "<br><a href=act_fam_view2.php?family=$family target=_self><P align=center >Remove Activity</h1></a>"; ?></div>
