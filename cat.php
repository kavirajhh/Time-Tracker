		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url(images/bg-01.jpg);">
					<div align="center">
					  <p class="login100-form-title-1 style3">ADD CATEGORY </p>
					  </div>
				</div>

				<form class="login100-form validate-form" action=catup.php method="post">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Category name is required">
						<span class="label-input100">Job Category </span>
						<input class="input100" type="text" name="cat_name" placeholder="Enter Job Category">
