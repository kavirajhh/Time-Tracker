	...
	<div>
		<div >
					<div class="wrap-input100 validate-input m-b-26">
						<div class="input100" align="right"><h1><a href=obdownload.php><img src="images/bt.jpg" width="15%"></a></h1></div>
					</div>
				...
				include "dbconnection.php";
					...
					if ($result->num_rows > 0) 
						...
						echo "<tr><TH>#</TH><TH>Doc No</TH><TH>Family</TH><TH> Activity</TH><TH>Job Start Date</TH><TH>Job Start Time</TH><TH>Job End Time</TH><th> Duration</TH><TH>Drop Reason</TH><th>Banker</TH><TH>Branch</TH><th>observer</th></tr>";
						{	while($row = mysqli_fetch_assoc($result)) {
								...
								//echo <p>$name</P>";
								echo "<tr><td>$i</td><td>$docno</td><td>$family</td><td>$jobid <br>$remark</td><td>$jsdate</td><td>$jstime</td><td>$e</td><td>$d</td><td>$rid</td><td>$banker </td><td>$branch</td><td>$obname</td></tr>";
